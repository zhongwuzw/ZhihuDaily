...
- (void)initUI{
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-0-[_webView]-43-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(_webView)]];
